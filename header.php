...
?>
    ...
    <body>
        <header class="header">
            <p class="header__title header__title--hll">Bonjour</p>
            <h1 class="header__title header__title--nm">Roman Czerkies</h1>
            <h2 class="header__subtitle"><span class="header__wrd header__wrd--dv">Développeur</span> <span class="header__wrd header__wrd--dev header__wrd--wb">Web</span> <span class="header__wrd header__wrd--fll">Full</span> <span class="header__wrd header__wrd--stck">Stack,</span><br><span class="header__wrd header__wrd--u">U</span><span class="header__wrd header__wrd--i">I</span> <span class="header__wrd header__wrd--dsgn">Designer</span></h2>
        </header>
        <main>
